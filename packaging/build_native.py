...
WINDOWS_INSTALL_DIR = r"$LOCALAPPDATA\Programs\WireViz Studio"
WINDOWS_START_MENU_DIR = r"$SMPROGRAMS\WireViz Studio"
WINDOWS_DESKTOP_SHORTCUT = r"$DESKTOP\WireViz Studio.lnk"
...
def _build_windows_installer(app_dir: Path, target: str, version_text: str) -> Path:
    ...
    nsis_script.write_text(
        (
            ...
            "Name \"WireViz Studio\"\n"
            f"OutFile \"{out_file}\"\n"
            f"InstallDir \"{WINDOWS_INSTALL_DIR}\"\n"
            ...
            "\n"
            "Section \"Application Files\" SEC_APP_FILES\n"
            ...
            "SectionEnd\n"
            "\n"
            "Section \"Start Menu Shortcut\" SEC_START_MENU_SHORTCUT\n"
            "  SetShellVarContext current\n"
            f"  CreateDirectory \"{WINDOWS_START_MENU_DIR}\"\n"
            f"  CreateShortCut \"{WINDOWS_START_MENU_DIR}\\WireViz Studio.lnk\" \"$INSTDIR\\WireVizStudio.exe\"\n"
            "SectionEnd\n"
            "\n"
            "Section \"Desktop Shortcut\" SEC_DESKTOP_SHORTCUT\n"
            "  SetShellVarContext current\n"
            f"  CreateShortCut \"{WINDOWS_DESKTOP_SHORTCUT}\" \"$INSTDIR\\WireVizStudio.exe\"\n"
            "SectionEnd\n"
            "\n"
            "Section \"Uninstall\"\n"
            "  SetShellVarContext current\n"
            f"  Delete \"{WINDOWS_DESKTOP_SHORTCUT}\"\n"
            f"  Delete \"{WINDOWS_START_MENU_DIR}\\WireViz Studio.lnk\"\n"
            f"  RMDir \"{WINDOWS_START_MENU_DIR}\"\n"
            "  RMDir /r \"$INSTDIR\"\n"
            "SectionEnd\n"
        ),
        encoding="utf-8",
